	...
	<body>
		...
		<section class="section" id="contact-us" data-aos="fade-up">
        	...
        	<div class="web-container" data-aos="fade-up">
            	...
            	<p class="price">Get your own website</p>
            	<p>We can conjure you up a one-of-a-kind website. Service includes design of wireframe, development, deployment, and life-time maintenance. Contact us, today, to schedule a consultation. <br> Price ranges from $500 - $5000 <br> You'll never pay more!</p>
		...
		<footer id="footer">
			...
			<div class="row">
				...
				<div class="left-text-content">
					<div class="row">
						<div class="col-md-2 col-xs-6" id="bottom-logo-1">
